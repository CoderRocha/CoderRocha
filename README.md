...
💼 Main stack: <strong>React, Laravel, JavaScript, PHP and SQL</strong>.

📚 Currently, I'm improving my skills in <strong>APIs</strong> and <strong>back-end architecture</strong>.
