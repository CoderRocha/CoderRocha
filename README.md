...
💼 Currently, i'm primally focused on <strong>React</strong> and <strong>PHP.</strong>

📚 But i also want to learn more about <strong>Laravel</strong>, <strong>Node.js</strong> and <strong>SQL</strong>.
