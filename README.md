...
💼 Currently, i'm primally focused on <strong>Next.js</strong> and <strong>PHP.</strong>

📚 But i also want to learn more about <strong>Laravel</strong> and <strong>SQL.</strong>
